...
| **Trust plane (ceremony, custody, recovery)** | `docs/architecture/TRUST_CEREMONY_LIFECYCLE.md`, `TRUST_ROOT_UPGRADE.md`, `TRUST_ROOT_BOOTSTRAP.md`, `TRUST_SIGNING_CUSTODY.md`, `TRUST_ROOT_RECOVERY.md` |
