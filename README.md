...
- [Portable workflow contract](./docs/guides/PORTABLE_WORKFLOW_CONTRACT.md) — non-normative cross-harness projection contract, subordinate to the native harness
