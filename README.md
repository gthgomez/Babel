...
> still matter. See [the claims matrix](./docs/status/claims-matrix.md) for the
...
governed harness. It is not yet claiming parity with Codex, Grok Build,
OpenCode, Claude Code, or other mature coding agents. The current comparative
baseline and catch-up work are documented in the
[four-way harness teardown](./docs/audit/BABEL_VS_CODEX_GROK_OPENCODE_HARNESS_TEARDOWN_2026-07-24.md).
...
- [OSS docs critique](./docs/OSS_DOCS_CRITIQUE_2026-08-01.md) — positioning review and editorial decisions
