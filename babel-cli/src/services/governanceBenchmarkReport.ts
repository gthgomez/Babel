...
export function generateGovernanceBenchmarkReport(
  options: GovernanceBenchmarkReportOptions,
): GovernanceBenchmarkReportSummary {
...
export function formatGovernanceBenchmarkReport(
  ...
  for (const result of results) {
    const verifier =
      result.metrics.verifier_passed === null
        ? 'n/a'
        : result.metrics.verifier_passed
          ? 'passed'
          : 'failed';
    lines.push(
