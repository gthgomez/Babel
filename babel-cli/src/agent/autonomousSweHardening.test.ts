...
test("worker-facing execution module has no issuer and ordinary loading cannot mint authority", () => {
  ...
  // TrustedExecutionRegistryV1 remains exported here on purpose: canonical
  // Babel keeps the passive identity registry alongside the supervisor
  // loader. The registry stores identities; it cannot mint authority.
});
