...
/**
 * Babel Parity-Audit Runner (Example Finance Forecast)
 *
 ...
 * - Source: C:\MockWorkspace\example_autonomous_agent\Example Finance Forecast (Python)
 * - Target: C:\MockWorkspace\Example Finance Forecast-app (Kotlin/Android)
 */

const PYTHON_PROJECT_ROOT = 'C:\\MockWorkspace\\example_autonomous_agent\\Example Finance Forecast';
const ANDROID_PROJECT_ROOT = 'C:\\MockWorkspace\\Example Finance Forecast-app';
