...
async function main(): Promise<void> {
  const task = [
    ...
    'C:\\MockWorkspace\\Example-Mobile-Finance\\app\\src\\main\\java\\com\\example\\app\\processing\\MissingFeature.kt',
  ...
  assert(
    normalizedTargets[0] === 'C:/MockWorkspace/Example-Mobile-Finance/app/src/main/java/com/example/app/processing/MissingFeature.kt',
