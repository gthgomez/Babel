...
**Status:** DEPRECATED - superseded by `00_System_Router/OLS-v9-Orchestrator.md`.
**Do not load.**

This stub is archived for lineage only. It emitted physical prompt file paths and predates the typed
`instruction_stack` + `resolution_policy` runtime lane.

---

## Historical Stub Content
