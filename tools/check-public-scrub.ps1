...
$lockfileSafetyRules = @(
  ...
  @{ Label = 'private dependency fingerprint'; Pattern = '(?i)([REDACTED_PRIVATE_IDENTIFIER]|GPCGuard|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER])' },
  @{ Label = 'private repository URL'; Pattern = '(?i)https?://[^"''\s]*([REDACTED_PRIVATE_IDENTIFIER]|GPCGuard|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER]|[REDACTED_PRIVATE_IDENTIFIER])[^"''\s]*' }
)
