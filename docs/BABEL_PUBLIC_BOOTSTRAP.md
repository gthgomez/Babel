...
This document bootstraps `Babel-public` from `[REDACTED_PRIVATE_IDENTIFIER]`.
...
From the `[REDACTED_PRIVATE_IDENTIFIER]` repo root:
...
5. Apply any final public-only hardening inside `Babel-public`, not `[REDACTED_PRIVATE_IDENTIFIER]`
