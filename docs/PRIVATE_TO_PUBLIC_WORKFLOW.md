...
`[REDACTED_PRIVATE_IDENTIFIER]` is the source-of-truth. `Babel-public` is a derived export.
...
1. Author and improve Babel in `[REDACTED_PRIVATE_IDENTIFIER]`
...
- New product work lands in `[REDACTED_PRIVATE_IDENTIFIER]` first
