...
Loopback ADR-010 control plane for ChatEngine. Stage 0–1 is the spike ledger.
V1 productizes the same path into a supervisory PWA.
...
| [BABEL_APPROVAL_BINDING_AUDIT.md](./BABEL_APPROVAL_BINDING_AUDIT.md) | Approval identity and digest |
| [BABEL_REMOTE_SPIKE_RESULTS.md](./BABEL_REMOTE_SPIKE_RESULTS.md) | Historical Stage-1 spike ledger |

Not a product announcement. Status labels in those files are the authority.
Do not convert `NOT_VERIFIED` to `VERIFIED` without machine evidence.
