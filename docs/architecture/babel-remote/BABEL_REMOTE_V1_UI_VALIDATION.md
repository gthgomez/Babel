...
This verifies that the real Remote PWA shell renders at the checked viewport sizes,
...
This class can establish a real browser connection to `babel remote serve`, bearer
