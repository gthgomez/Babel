...
| Watcher unavailable or silent | VERIFIED | Reconciliation marks watcher source unavailable; hash evidence remains independent | Unknown from watcher alone | HIGH | HIGH | MEDIUM | No watcher event never proves no mutation |
