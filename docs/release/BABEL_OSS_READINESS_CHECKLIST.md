...
- [x] Release validation test commands exist and cover catalog validation, router regression, and manifest assembly.
...
- [ ] Usage examples exist for multiple model providers.
