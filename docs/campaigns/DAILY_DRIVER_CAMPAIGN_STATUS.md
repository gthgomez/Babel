...
| 2026-09-05 | `babel models list` real-output smoke | repaired renderer | pass — `deepseek-v4-pro-openrouter` now renders `n/a` cost (previously fabricated `$0/M`); single-tier route renders `none — single-tier route` |
