...
**DEPRECATED - superseded by `02_Domain_Architects/Clean_SWE_Frontend-v6.md` plus targeted UI/UX, accessibility, state-completeness, and design-token skills. Do not load as an active domain architect.**
