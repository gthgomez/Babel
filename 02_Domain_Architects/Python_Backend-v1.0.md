...
### Multi-Agent Pipeline (example_saas_backend — `[REDACTED_PRIVATE_IDENTIFIER]/`)
...
Verification:
  ...
  • Regression gate: python -m [REDACTED_PRIVATE_IDENTIFIER] regression-test --agent security (if pipeline changes)
