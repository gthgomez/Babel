...
# Skill: Android Unit Testing (v2.0)
...
### Testing constraint math (example_app_1 example)
...
```kotlin
// src/test/java/com.example_app_1/fakes/FakeExactUploadEngine.kt
...
// src/test/java/com.example_app_1/fakes/FakeBillingGateway.kt
