...
This skill covers the patterns used in example_saas_backend's multi-agent code review pipeline (`[REDACTED_PRIVATE_IDENTIFIER]/`). It applies whenever building or modifying:
