...
## Purpose
Formalizes the transition of a task between different specialized agents (e.g., Antigravity, example_autonomous_agent, Swarm workers) to maintain continuity and prevent context loss.
