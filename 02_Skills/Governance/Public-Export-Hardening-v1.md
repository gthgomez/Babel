...
**Category:** Governance
**Status:** Active
**Activation:** Load when preparing `[REDACTED_PRIVATE_IDENTIFIER]` content for `Babel-public` or any similar private-to-public repo export, especially when the task includes sanitization, example-overlay replacement, public scrub validation, or release-readiness review.
...
**Rule:** Do not use sanitization rules as permission to rewrite `[REDACTED_PRIVATE_IDENTIFIER]` into a pseudo-public repo.
...
1. Never mass-scrub `[REDACTED_PRIVATE_IDENTIFIER]` to make it publishable.
