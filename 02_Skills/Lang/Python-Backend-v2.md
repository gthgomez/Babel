...
- This skill provides Babel-specific conventions. It does not replace official platform documentation.
- Version-specific guidance must be verified against current stable releases before use.

## Failure Behavior of This Skill
- **Referenced API or platform detail is outdated:** Flag as STALE. Recommend verification.
...
- `skill_standards_currency_audit` (`02_Skills/Governance/Standards-Currency-Audit-v2.md`) — for re-verification.
